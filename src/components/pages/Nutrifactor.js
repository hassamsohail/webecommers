...
// import sofa from '../Nutrifactor/sofa.png'
// import '../App.css'
import '../../App.css'
...
function Nutrifactor() {
  const Nutrifactor = [
    {
      productName: 'Nutrifactor Nutin (BIOTIN 2500mcg) - 30 ',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../Nutrifactor/Nutrifactor1.PNG',
      Discription:
      ...
      video: '../Nutrifactor/vid.mp4',
    },
    {
      productName: 'Nutrifactor Nutin (BIOTIN 2500mcg) - 60 ',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../Nutrifactor/vid.mp4',

      productimg: '../Nutrifactor/Nutrifactor2.PNG',
      Discription:
    ...
    {
      productName: 'Nutrifactor Extra-C - 30 Tablets-cc Extra',
      productOffPrice: '1,995',
      productOnPrice: '1,197',
      OffPrice: '798',
      video: '../Nutrifactor/vid.mp4',

      productimg: '../Nutrifactor/Nutrifactor3.PNG',
      Discription:
    ...
    {
      productName: 'Nutrifactor Gluta Fair - 30 Capsules',
      productOffPrice: '1,890',
      productOnPrice: '1,134',
      OffPrice: '756',
      video: '../Nutrifactor/vid.mp4',

      productimg: '../Nutrifactor/Nutrifactor4.PNG',
      Discription:
  ...
  const ProductDetail = Nutrifactor.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
