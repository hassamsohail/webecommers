...
// import sofa from '../Eyeliner/sofa.jpeg'
// import '../App.css'
import '../../App.css'
...
function Eyeliner() {
  const Eyeliner = [
    {
      productName: 'Gabrini Liquid Eye Liner Pen',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../Eyeliner/Eyeliner1.jpeg',
      Discription:
      ...
      video: '../Eyeliner/vid.mp4',
    },
    {
      productName: 'Artdeco Mineral Eye Styler ',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../Eyeliner/vid.mp4',

      productimg: '../Eyeliner/Eyeliner2.jpeg',
      Discription:
    ...
    {
      productName: 'Beauty UK Glitter Liquid Eye ',
      productOffPrice: '1,890',
      productOnPrice: '1,134',
      OffPrice: '756',
      video: '../Eyeliner/vid.mp4',

      productimg: '../Eyeliner/Eyeliner4.jpeg',
      Discription:
  ...
  const ProductDetail = Eyeliner.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
