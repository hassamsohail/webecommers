...
// import sofa from '../janssen/sofa.png'
// import '../App.css'
import '../../App.css'
...
function Janssen() {
  const Janssen = [
    {
      productName: 'Janssen Botanica White Mask  ',
    ...
    {
      productName: 'Janssen Brightening Face Freshener',
    ...
    {
      productName: 'Janssen Brightening Day Protection ',
    ...
    {
      productName: 'Janssen Melafadin Fluid - 2 ml',
  ...
  const ProductDetail = Janssen.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
