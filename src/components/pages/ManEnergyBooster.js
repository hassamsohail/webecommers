...
// import sofa from '../ManEnergyBooster/sofa.jpeg'
// import '../App.css'
import '../../App.css'
...
function ManEnergyBooster() {
  const ManEnergyBooster = [
    {
      productName: 'ONCE A DAY MEN - 30 TABLETS ',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../ManEnergyBooster/ManEnergyBooster1.jpeg',
      Discription:
      ...
      video: '../ManEnergyBooster/vid.mp4',
    },
    {
      productName: 'ONCE A DAY X-MEN ',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../ManEnergyBooster/vid.mp4',

      productimg: '../ManEnergyBooster/ManEnergyBooster2.jpeg',
      Discription:
  ...
  const ProductDetail = ManEnergyBooster.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
...
export default ManEnergyBooster
