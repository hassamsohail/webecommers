...
// import sofa from '../FaceWash/sofa.jpeg'
// import '../App.css'
import '../../App.css'
...
function FaceWash() {
  const FaceWash = [
    {
      productName: 'Neutrogena Fresh & Clear Pink',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../FaceWash/FaceWash1.jpeg',
      Discription:
      ...
      video: '../FaceWash/vid.mp4',
    },
    {
      productName: 'Neutrogena Deep Clean Facial Wash ',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../FaceWash/vid.mp4',

      productimg: '../FaceWash/FaceWash2.jpeg',
      Discription:
    ...
    {
      productName: 'Eveline White Prestige 4D',
      productOffPrice: '1,995',
      productOnPrice: '1,197',
      OffPrice: '798',
      video: '../FaceWash/vid.mp4',

      productimg: '../FaceWash/FaceWash3.jpeg',
      Discription:
    ...
    {
      productName: 'Eveline White Prestige 4D Facial',
      productOffPrice: '1,890',
      productOnPrice: '1,134',
      OffPrice: '756',
      video: '../FaceWash/vid.mp4',

      productimg: '../FaceWash/FaceWash4.jpeg',
      Discription:
  ...
  const ProductDetail = FaceWash.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
