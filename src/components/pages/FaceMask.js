...
// import sofa from '../FaceMask/sofa.jpeg'
// import '../App.css'
import '../../App.css'
...
function FaceMask() {
  const FaceMask = [
    {
      productName: 'REGIME PACK - LOREAL PARIS REVITALIFT ',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../FaceMask/FaceMask1.jpeg',
      Discription:
      ...
      video: '../FaceMask/vid.mp4',
    },
    {
      productName: 'LOREAL PARIS HYALURON EXPERT HYALURON EXPERT ',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../FaceMask/vid.mp4',

      productimg: '../FaceMask/FaceMask2.jpeg',
      Discription:
    ...
    {
      productName: 'LOREAL PARIS REVITALIFT CRYSTAL ',
      productOffPrice: '1,995',
      productOnPrice: '1,197',
      OffPrice: '798',
      video: '../FaceMask/vid.mp4',

      productimg: '../FaceMask/FaceMask3.jpeg',
      Discription:
    ...
    {
      productName: 'EVELINE FACEMED+ CARBON MASK',
      productOffPrice: '1,890',
      productOnPrice: '1,134',
      OffPrice: '756',
      video: '../FaceMask/vid.mp4',

      productimg: '../FaceMask/FaceMask4.jpeg',
      Discription:
  ...
  const ProductDetail = FaceMask.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
