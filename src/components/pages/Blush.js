...
// import sofa from '../Blush/sofa.png'
// import '../App.css'
import '../../App.css'
...
function Blush() {
  const Blush = [
    {
      productName: 'Makeup Revolution Blusher Reloaded',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../Blush/Blush1.PNG',
      Discription:
  ...
  const ProductDetail = Blush.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
