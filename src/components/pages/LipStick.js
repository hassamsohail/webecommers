...
// import sofa from '../LipStick/sofa.png'
// import '../App.css'
import '../../App.css'
...
function LipStick() {
  const LipStick = [
    {
      productName: 'Nyx Lip Lingerie Liquid Lipstick',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../LipStick/1.PNG',
      Discription:
      ...
      video: '../LipStick/vid.mp4',
    },
    {
      productName: 'Makeup Revolution Matte Lipstick ',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../LipStick/vid.mp4',

      productimg: '../LipStick/2.PNG',
      Discription:
  ...
  const ProductDetail = LipStick.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
