...
// import sofa from '../Hairfall/sofa.jpeg'
// import '../App.css'
import '../../App.css'
...
function Hairfall() {
  const Hairfall = [
    {
      productName: 'BEAR HAIR VITAMINS  HAIR VITAMINS ',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../Hairfall/Hairfall1.jpeg',
      Discription:
      ...
      video: '../Hairfall/vid.mp4',
    },
    {
      productName: 'CONATURAL PEPPERMINT ESSENTIAL OIL',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../Hairfall/vid.mp4',

      productimg: '../Hairfall/Hairfall2.jpeg',
      Discription:
    ...
    {
      productName: 'NUTRIFACTOR NUTIN (BIOTIN 2500MCG) ',
      productOffPrice: '1,995',
      productOnPrice: '1,197',
      OffPrice: '798',
      video: '../Hairfall/vid.mp4',

      productimg: '../Hairfall/Hairfall3.jpeg',
      Discription:
    ...
    },
    {
      ...
      productimg: '../Hairfall/Hairfall4.jpeg',
      Discription:
  ...
  const ProductDetail = Hairfall.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
