...
// import sofa from '../WomenEnergyBooster/sofa.jpeg'
// import '../App.css'
import '../../App.css'
...
function WomenEnergyBooster() {
  const WomenEnergyBooster = [
    {
      productName: 'WELLNESS CO MONTHLY DOSE ESSENTIAL ',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../WomenEnergyBooster/Women Energy Booster1.jpeg',
      Discription:
      ...
      video: '../WomenEnergyBooster/vid.mp4',
    },
    {
      productName: 'ONCE A DAY WOMEN - 30 TABLETS',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../WomenEnergyBooster/vid.mp4',

      productimg: '../WomenEnergyBooster/WomenEnergyBooster2.jpeg',
      Discription:
  ...
  const ProductDetail = WomenEnergyBooster.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
...
export default WomenEnergyBooster
