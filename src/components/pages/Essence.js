...
// import sofa from '../Essence/sofa.png'
// import '../App.css'
import '../../App.css'
...
function Essence() {
  ...
  const ProductDetail = Essence.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
