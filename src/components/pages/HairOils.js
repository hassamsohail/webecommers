...
// import sofa from '../HairOils/sofa.jpeg'
// import '../App.css'
import '../../App.css'
...
function HairOils() {
  const HairOils = [
    {
      productName: 'KEUNE CARE SATIN OIL MASK SMOOTH ',
      productOffPrice: '2,149',
      productOnPrice: '1,289',
      OffPrice: '860',
      productimg: '../HairOils/HairOils1.jpeg',
      Discription:
      ...
      video: '../HairOils/vid.mp4',
    },
    {
      productName: 'WELLNESS CO REJUVENATING ELIXIR HAIR OIL ',
      productOffPrice: '1,99',
      productOnPrice: '839',
      OffPrice: '560',
      video: '../HairOils/vid.mp4',

      productimg: '../HairOils/HairOils2.jpeg',
      Discription:
    ...
    {
      productName: 'WELLNESS CO HAIR FALL THERAPY HAIR OIL',
      productOffPrice: '1,995',
      productOnPrice: '1,197',
      OffPrice: '798',
      video: '../HairOils/vid.mp4',

      productimg: '../HairOils/HairOils3.jpeg',
      Discription:
    ...
    {
      productName: 'WELLNESS CO HAIR DENSITY HAIR OILL',
      productOffPrice: '1,890',
      productOnPrice: '1,134',
      OffPrice: '756',
      video: '../HairOils/vid.mp4',

      productimg: '../HairOils/HairOils4.jpeg',
      Discription:
  ...
  const ProductDetail = HairOils.map((item) => (
    <div
      onClick={() => {
        history.push('/Cart', {
